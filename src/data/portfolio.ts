export const portfolioData = {
    about: {
        ...
        tagline:
            "Computer Science student and Fullstack Developer specializing in Python, React, and Machine Learning. Building scalable, impact-driven software solutions.",
        description:
            "I'm a Computer Science student and Fullstack Developer who has built real-world web applications and privacy-focused AI systems. I specialize in bridging the gap between robust backend engineering and intuitive user experiences, with a strong focus on Python and modern JavaScript frameworks.",
        experience: "1+ Year",
    ...
    experience: [
        ...
        },
        {
            ...
            location: "Remote",
            bullets: [
                "Working on data analysis tasks and community tech projects.",
            ],
            link: "",
        },
    ],
    ...
    projects: [
        {
            ...
            liveUrl: "https://drive.google.com/file/d/1LSeHxZmkLEUtLuDVUy_04vykA4f8RitQ/view?usp=sharing",
            problem:
